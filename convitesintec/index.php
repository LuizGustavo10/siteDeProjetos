...
<style>
  *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .sched-inline { width: 100%; margin-bottom: 14px; }
...
<div id="celebration">
  ...
  <div class="celebrate-title"><i class="fa-solid fa-star"></i> Confirmado! <i class="fa-solid fa-star"></i></div>
  <div class="celebrate-sub">Sua presença foi registrada com sucesso.<br>Nos vemos no <strong>SINTEC 2.0</strong>!</div>
  <div class="celebrate-date"><i class="fa-regular fa-calendar-check"></i> 19 a 23 de Outubro &nbsp;·&nbsp; Semana Toda</div>
  <button class="btn-close" onclick="closeCelebration()">Incrível! <i class="fa-solid fa-check"></i></button>
</div>
...
<div class="layout">
  <div class="page">
    ...
    <!-- <div class="dome-wrap"> </div> -->
    <img src="logo.png" alt="" class="logo-img">

    <div class="tagline">Semana da inovação e tecnologia </div>

    <h1>Convite Especial</h1>

    <div class="glass">
      <p class="intro">Temos o prazer de convidar você para a <strong style="color:#fff">SINTEC 2.0</strong>, um evento que apresenta projetos, ideias e tecnologias desenvolvidas por instrutores e alunos, explorando tendências do futuro, estratégias de mercado e inovação na prática.</p>
    </div>

    <div class="info-row">
      <div class="info-card">
        <div class="info-label"><i class="fa-regular fa-calendar"></i> Período</div>
        <div class="info-value">19 à 22 Out</div>
      </div>
      <div class="info-card">
        <div class="info-label"><i class="fa-regular fa-clock"></i> Horário</div>
    ...
    <div class="sched-inline">
      <div class="schedule-title"><i class="fa-solid fa-list-check"></i> Programação</div>

      <div class="continuous-badge">
        <span class="cb-icon"><i class="fa-solid fa-display"></i></span>
      ...
      <div class="sched-day" id="day-seg">
        ...
        <div class="sched-items">
          <div class="sched-item">
            ...
            <div class="sched-desc">Abertura oficial, apresentação cultural e bate papo com profissionais de TI.</div>
          </div>
        </div>
      </div>
      ...
      <div class="sched-day" id="day-ter">
        ...
        <div class="sched-items">
          ...
          <div class="sched-item">
            ...
            <div class="sched-desc">Ideathon — Maratona de ideias: criação de soluções reais, pitch e premiação.</div>
          </div>
        </div>
      </div>
    ...
    <div class="format-box">
      <div class="format-title"><i class="fa-solid fa-gears"></i> Formato do Evento</div>
    ...
    <div class="deadline"><strong>Confirmação até 30 de abril.</strong> Garanta sua participação.</div>

    <div class="rsvp-box" id="rsvpSection">
      <div class="rsvp-question">Confirme sua presença abaixo <i class="fa-solid fa-arrow-down"></i></div>

      <div class="input-wrap">
        <label for="guestName"><i class="fa-solid fa-user"></i> Seu nome completo</label>
        <input
          type="text"
          id="guestName"
          class="name-input"
      ...
      <div class="btn-row">
        <button class="btn btn-yes" id="btnYes" onclick="confirmPresence()"><i class="fa-solid fa-check"></i> Confirmar presença</button>
        <button class="btn btn-no" id="btnNo" onclick="tryDecline(event)"><i class="fa-solid fa-xmark"></i> Não posso ir</button>
      </div>
    </div>

    <div class="declined-msg" id="declinedMsg">
      <div class="declined-icon"><i class="fa-regular fa-face-sad-tear" style="font-size:3rem;color:var(--text-dim);"></i></div>
      <div class="declined-text">Sentiremos sua falta!<br><strong>Esperamos te ver em futuros eventos.</strong></div>
      <button class="btn btn-yes" style="max-width:230px;margin-top:10px;" onclick="resetRSVP()"><i class="fa-solid fa-rotate-left"></i> Mudar resposta</button>
    </div>
...
async function confirmPresence(){
  ...
  try {
    ...
    if(data.success){
      document.getElementById('celebrateName').innerHTML = '<i class="fa-solid fa-star" style="color:var(--cyan);font-size:.8rem;"></i> Olá, ' + name + '!';
      spawnConfetti(); spawnConfetti(); drawConfetti();
      document.getElementById('celebration').classList.add('active');
    } else {
      showToast(data.message || 'Erro ao salvar. Tente novamente.', true);
      btn.disabled=false; btn.innerHTML='<i class="fa-solid fa-check"></i> Confirmar presença';
    }
  } catch(e){
...
function closeCelebration(){
  ...
  section.innerHTML = `<div style="display:flex;justify-content:center;">
    <div class="confirmed-badge"><i class="fa-solid fa-circle-check"></i> Presença Confirmada &nbsp;·&nbsp; Até 19–23 de Outubro!</div>
  </div>`;
}
